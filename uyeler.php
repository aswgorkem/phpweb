...
<br><span style="float:left;width:100%;margin:1px;">
<b>Şehir:</b> '.$byardimci['sehir'].'</span>';
...
$vtsorgu = "SELECT id,kullanici_adi,mesaj_sayisi,katilim_tarihi,yetki,sehir_goster,sehir,engelle FROM $tablo_kullanicilar WHERE kullanici_adi LIKE '$_GET[kul_ara]%' ORDER BY ";
