...
if ($ayarlar['bbcode'] == 1)
{
	...
	if ((isset($_POST['bbcode_kullan'])) AND ($_POST['bbcode_kullan'] == 1)) $form_ozellik .= ' checked="checked"';
...
if ((isset($_POST['ifade'])) AND ($_POST['ifade'] == 0)) $form_ozellik .= '';
...
$form_bilgi1 = '<form action="bilesenler/oi_yaz_yap.php" method="post" onsubmit="return '.$phpkf_duzenleyici.' denetle_duzenleyici()" name="form1">
<input type="hidden" name="kayit_yapildi_mi" value="form_dolu">
<input type="hidden" name="oino" value="'.$oi_no.'">'.$form_yanitla;


$form_bilgi2 = '<form action="oi_yaz.php#onizleme" method="post" name="form2" onsubmit="return '.$phpkf_duzenleyici.' onizle_duzenleyici(), denetle_duzenleyici()">
<input type="hidden" name="oino" value="'.$oi_no.'">
<input type="hidden" name="ozel_kime" value="'.$ozel_kime.'">
<input type="hidden" name="kayit_yapildi_mi" value="form_dolu">
<input type="hidden" name="bbcode_kullan" value="">
<input type="hidden" name="ifade" value="">
<input type="hidden" name="mesaj_baslik" value="">
<input type="hidden" name="mesaj_icerik" value="">'.$form_yanitla;
