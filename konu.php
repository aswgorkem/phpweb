...
if ($mesaj_sahibi['resim'] != '') $konu_acan_resmi = '<img src="'.$mesaj_sahibi['resim'].'" alt="Kullanıcı Resmi">';
elseif ($ayarlar['kul_resim'] != '') $konu_acan_resmi = '<img src="'.$ayarlar['kul_resim'].'" alt="Varsayılan Kullanıcı Resmi">';
...
if ($cevap_sahibi['resim'] != '')
	$cevap_yazan_resmi = '<img src="'.$cevap_sahibi['resim'].'" alt="Kullanıcı Resmi">';
elseif ($ayarlar['kul_resim'] != '')
	$cevap_yazan_resmi = '<img src="'.$ayarlar['kul_resim'].'" alt="Varsayılan Kullanıcı Resmi">';
...
{
	$alt_forum_baslik = '<a href="'.linkver('forum.php?f='.$mesaj_satir['hangi_forumdan'].'&fs='.$_GET['fs'], $forum_satir['forum_baslik']).'">'.$forum_satir['forum_baslik'].'</a>';
