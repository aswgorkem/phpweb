...
$vtsorgu = "SELECT id,son_ileti,son_giris FROM $tablo_kullanicilar WHERE kullanici_kimlik='$_COOKIE[kullanici_kimlik]' LIMIT 1";
...
elseif ((isset($_GET['kip'])) AND ($_GET['kip'] == 'takip'))
{
	...
	$takip_sonuc = $vt->query($vtsorgu) or die ($vt->hata_ver());
