...
'{FORUM_OZEL_KLASOR}' =>  'src="temalar/'.$ayarlar['temadizini'].'/resimler/forum01.gif" width="0" height="0" alt="boş"',
'{FORUM_BAGLANTI}' => '#',
...
$sonmesaj_baslik = 'Henüz yazı<br>bulunmamaktadır';
...
//  son konunun başlığı yazdırılıyor, uzunsa kısaltılıyor  //
...
<a href="'.linkver('profil.php?kim='.$son_mesaj['yazan'],$son_mesaj['yazan']).'" title="Kullanıcı Profilini Görüntüle">'.$son_mesaj['yazan'].'</a>';
...
$sonmesaj_baslik .= '<br><b>Yazan: </b>
<a href="'.linkver('profil.php?kim='.$son_mesaj['son_cevap_yazan'],$son_mesaj['son_cevap_yazan']).'" title="Kullanıcı Profilini Görüntüle">'.$son_mesaj['son_cevap_yazan'].'</a>';
